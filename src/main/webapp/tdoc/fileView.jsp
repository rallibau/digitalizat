    ...
    <tiles:putAttribute name="body">
        ...
        <div  id="my-tab-content" class="tab-content">
            <div class="tab-pane active" id="document" style="text-align: center; width: 100%">
                <c:if test="${documento.mime eq 'pdf.png'}">
                ...
                <c:if test="${documento.mime ne 'pdf.png'}">
                    <div style="max-width: 1024px; margin: auto;">

                        <div class="row-fluid">
                            <div class="span12">
                                Este fichero no dispone de previsializaci&oacute;n <a href="${pageContext.request.contextPath}/server/obtenerFichero/${documento.id}">descargar</a>
                            </div>
                        </div>
                    </div>
                </c:if>
